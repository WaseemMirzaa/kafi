    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 6),
          _howStep('1', AppStrings.refsStep1.tr, isWarn: false),
          const SizedBox(height: 5),
          _howStep('2', AppStrings.refsStep2.tr, isWarn: false),
          const SizedBox(height: 5),
          _howStep('3', AppStrings.refsStep3.tr, isWarn: false),
          const SizedBox(height: 5),
          _howStep('!', AppStrings.refsStep4.tr, isWarn: true),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: KafiTextField(
                  ...
                  hint: AppStrings.refsYearsHint.tr,
                ),
              ),
            ],
          ),
          KafiTextField(
            ...
            hint: AppStrings.refsCanConfirmHint.tr,
          ),
          Container(
